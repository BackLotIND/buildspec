...
const MAKES = [
  ...
  { id:"mazda",name:"Mazda",accent:"#D4380D",tagline:"Lightweight, revs, and rotary legends — the driver's choice",icon:"🔶" },
  { id:"toyota",name:"Toyota",accent:"#1A1A1A",tagline:"Bulletproof reliability meets off-road and track heritage",icon:"🏔" },
  { id:"nissan",name:"Nissan",accent:"#C41230",tagline:"Z cars, drift legends, and the trucks that refuse to die",icon:"🔻" },
  { id:"ford",name:"Ford",accent:"#003399",tagline:"Mustangs, F-150s, and the trucks that built America",icon:"🔷" },
  { id:"chevy",name:"Chevy",accent:"#D4A017",tagline:"LS everything — from Camaros to Silverados, the V8 never dies",icon:"🟡" },
  { id:"vw",name:"Volkswagen",accent:"#0D47A1",tagline:"German engineering at human prices — the GTI started it all",icon:"🔹" },
];
