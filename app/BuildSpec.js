...
const PARTS = [
  ...
  {id:"s22b",name:"Invidia N1 Catback",brand:"Invidia",cat:"exhaust",price:450,desc:"Single-exit catback — louder than R400, iconic Invidia N1 sound. Stainless construction, good fitment.",hp:3,tq:3,ret:"Amazon",sk:3,time:2,tools:"14mm, jack stands",notes:"The N1 sound is iconic in the Subaru world. Louder than R400 but not as loud as muffler delete.",plats:["gd","gr","va"]},
  ...
  {id:"w2",name:"Enkei RPF1 15x7 +41 (×4)",brand:"Enkei",cat:"wheels",price:1100,desc:"Forged lightweight legend in 15\". The gold standard. Nothing beats RPF1 for weight savings.",hp:0,tq:0,ret:"Fitment Industries",sk:1,time:0.5,tools:"Lug wrench, torque wrench",notes:"The lightest option available. Expensive but the weight savings improve everything — acceleration, braking, turn-in.",plats:["eg","ek"]},
  ...
  {id:"w9",name:"Enkei RPF1 18x9.5 +38 (×4)",brand:"Enkei",cat:"wheels",price:1500,desc:"The forged gold standard for Subaru. Aggressive fitment that fills the WRX/STI fenders perfectly.",hp:0,tq:0,ret:"Fitment Industries",sk:1,time:0.5,tools:"Lug wrench, torque wrench",notes:"56.1mm bore — hub-centric rings mandatory. 18x9.5 +38 is the go-to aggressive WRX fitment.",plats:["gd","gr","va"]},
  {id:"w10",name:"Rota Grid 18x9.5 +38 (×4)",brand:"Rota",cat:"wheels",price:600,desc:"⚠️ BUDGET: Cast replica wheels in popular Subaru fitment. Heavy but affordable.",hp:0,tq:0,ret:"eBay",sk:1,time:0.5,tools:"Lug wrench, torque wrench",notes:"⚠️ Budget disclaimer: the Subaru community has strong opinions about Rotas. They work for daily driving but the weight negates some of the handling improvement. Save for Konig or Enkei if you can.",plats:["gd","gr","va"]},
  ...
  {id:"x8",name:"Rally Mud Flaps (WRX/STI)",brand:"RokBlokz",cat:"ext",price:100,desc:"Thick polyurethane rally-style mud flaps. Protects paint and adds the rally look. The most popular exterior mod on WRX.",hp:0,tq:0,ret:"Amazon",sk:1,time:0.5,tools:"Phillips, 10mm",notes:"15-minute install. Protects the paint behind the wheels from rock chips. Looks great on lowered cars too.",plats:["gd","gr","va"]},
